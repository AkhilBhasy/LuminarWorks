...
//list all todos completed by userid 1
console.log("all todos completed by userid 1");
console.log(todos.filter(todo=>todo.userId==1&&todo.completed==true)); 




//list all todos completed by userid 2
console.log("all todos completed by userid 2");
console.log(todos.filter(todo=>todo.userId==2&&todo.completed==true)); 
...
console.log("no:of pending todos for userid 1");
var cnt=0;
cnt=todos.filter(todo=>todo.userId==1&&todo.completed==false).length;
console.log(cnt);
